...
$commands = "", "enable", "term len 0", "show version", "show interfaces description", "show interfaces", "show interfaces trunk","show ip interface","show mac address-table","show ip arp","show vlan","show cdp neighbor detail", "show spanning-tree detail", "show run" ,"exit"
